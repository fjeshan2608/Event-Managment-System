			...
			<section id="blog" class="row">
				...
				<p class="sub-text text-center">Awesome news and articles from us</p>	
					...
					<div class="content">
					  ...
					  <div class="blog col-md-4">
					    ...
					    <img class="blog-image" src="storage/front/images/demo/blog2.jpg" width="100%" height="250" alt="Blog Image 2"/>
					  ...
					  <div class="blog col-md-4">
					    ...
					    <img class="blog-image" src="storage/front/images/demo/blog1.jpg"  width="100%" height="250" alt="Blog Image 2"/>
				...
				<div class="title-start team-menu col-md-4 col-md-offset-4">
					...
					<div class="col-md-3 col-sm-6 member">
						<img class="blog-image" src="storage/front/images/team1.jpg" width="100%" height="280" alt="Blog Image 2"/>
					...
					<div class="col-md-3 col-sm-6 member">
						<img class="blog-image" src="storage/front/images/team2.jpg" width="100%" height="280" alt="Blog Image 2"/>
					...
					<div class="col-md-3 col-sm-6 member">
						<img class="blog-image" src="storage/front/images/team3.jpg" width="100%" height="280" alt="Blog Image 2"/>
					...
					<div class="col-md-3 col-sm-6 member">
						<img class="blog-image" src="storage/front/images/team4.jpg" width="100%" height="280" alt="Blog Image 2"/>
